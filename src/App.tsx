...
const DataCenter = () => {
  const categories = [
    { name: 'Data Pegawai', count: 450, icon: Users },
    { name: 'SK & Dokumen Resmi', count: 820, icon: FileText },
    { name: 'Laporan Kinerja', count: 120, icon: BarChart3 },
    { name: 'Arsip Digital', count: 2400, icon: Database },
  ];
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-zinc-100">
              {[
                { name: 'SK_Kenaikan_Pangkat_2024.pdf', cat: 'SK & Dokumen', date: '12 Mar 2024', size: '2.4 MB' },
                { name: 'Data_Statistik_Pegawai_Q1.xlsx', cat: 'Data Pegawai', date: '10 Mar 2024', size: '1.1 MB' },
                { name: 'Laporan_PIKP_Bulanan.docx', cat: 'Laporan', date: '08 Mar 2024', size: '850 KB' },
                { name: 'Arsip_Pembinaan_Disiplin.pdf', cat: 'Arsip Digital', date: '05 Mar 2024', size: '4.2 MB' },
              ].map((file, i) => (
                <tr key={i} className="hover:bg-zinc-50 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <button className="text-yellow-600 font-bold text-xs uppercase hover:underline">Download</button>
                  </td>
                </tr>
              ))}
            </tbody>
